...
ENV MAIL_DEFAULT_SENDER mail@example.tld
ENV EMAIL_SENDER mail@example.tld
ENV SECURITY_EMAIL_SENDER mail@example.tld
ENV SECURITY_SEND_REGISTER_EMAIL  true
ENV SECURITY_SEND_PASSWORD_CHANGE_EMAIL  true
ENV SECURITY_SEND_PASSWORD_RESET_NOTICE_EMAIL  true
